...
import com.te.schedule.service.DepartmentService;

public class ServletDepartmentMapper {
	...
	public ServletDepartmentMapper(ServletEmployeeMapper employeeMapper, DepartmentDao departmentDao) {
