...
<body>
	<header>
		<nav>
			<ul>
				<li><a href="<%=request.getContextPath()%>/listCompanies">Companies</a></li>
			</ul>
			<ul>
	...
	<div>
		...
		<fieldset>
			<label>Company Street</label> <input type="text"
				value="<c:out value='${company.street}'/>" name="street"
				required="required">
		</fieldset>
		<fieldset>
			<label>Company Number</label> <input type="number"
				value="<c:out value='${company.number}'/>" name="number"
				required="required">
		</fieldset>
		<fieldset>
