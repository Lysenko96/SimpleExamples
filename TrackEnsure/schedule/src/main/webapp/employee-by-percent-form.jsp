...
<body>
	...
	<div>
		...
		<fieldset>
			...
			<p>
				<input type="radio" value="OFFICE" name="type" required="required">OFFICE<br>
				<input type="radio" value="AFTER" name="type" required="required">AFTER<br>
				<input type="radio" value="REMOTE" name="type" required="required">REMOTE<br>
				<input type="radio" value="BEFORE" name="type" required="required">BEFORE<br>
			</p>
		</fieldset>
		<fieldset>
