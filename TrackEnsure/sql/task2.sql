...
SELECT "Customer"."FirstName", "Customer"."LastName", "Invoice"."InvoiceId", "Invoice"."InvoiceDate", "Invoice"."BillingCountry"  FROM "Invoice", "Customer" WHERE "Customer"."Country" = 'Brazil';
...
SELECT "Employee"."LastName", "Employee"."FirstName", "Invoice".* FROM "Employee", "Invoice" WHERE "Title"='Sales Support Agent';

-- Provide a query that shows the Invoice Total, Customer name, Country and Sale Agent name for all invoices and customers
SELECT DISTINCT "Invoice"."Total", "Customer"."FirstName", "Customer"."Country", "Employee"."FirstName" FROM "Invoice", "Customer", "Employee" WHERE "Employee"."Title"='Sales Support Agent';

-- How many Invoices were there in 2009 and 2011? 
SELECT * FROM "Invoice" WHERE "InvoiceDate" BETWEEN '2009-01-01' AND '2011-01-01';
