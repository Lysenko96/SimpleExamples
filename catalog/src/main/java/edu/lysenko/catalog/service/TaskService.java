...
//		}
	...
	public String delete(Task task, int userId) {
		...
		// userDao.getById(UserService.getId()).getRole().equals(Role.ADMIN)) {
...
//		List<Integer> taskIdsFilter = new ArrayList<>();
//		for (Task task : taskDao.searchAllByTag(keyword)) {
//			taskIdsFilter.add(task.getId());
//		}
//		List<Integer> taskIds = taskDao.getAllTaskIdsByUserId(userId);
