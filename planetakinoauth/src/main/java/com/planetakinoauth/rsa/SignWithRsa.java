...
//        private static final String url = "https://api-integration.dev.planeta8.net/api/v1.0/customer?page=1&perPage=25&sortOrder=desc&sortBy=createdAt";
        private static final String url = "api/v1.0/customer";
