...
import net.gweep.voting.entity.StrationSercretService;
...
//		System.out.println(citizen11);
		...
		Citizen citizen = new Citizen("name2", "bk103452", 1122334456, 2005, null, party, false, true);
		// Citizen citizen2 = new Citizen("name3", "bk103453", 1122334457, 1994, null,
		// party3, true, false);
		Citizen citizen3 = new Citizen("name4", "bk103454", 1122334458, 1996, null, party2, true, false);
		...
		StationQuarantine stationQuarantine = new StationQuarantine(2, new Address("street2", 10), citizens,
				citizens.size());
		StrationSercretService sercretService = new StrationSercretService(3, new Address("street3", 11), citizens,
				citizens.size());
		...
		Candidate candidate = new Candidate("name", "bk103451", 1122334455, 1994, null, party, false, false, 3);
		Candidate candidate1 = new Candidate("name1", "bk103459", 1122334459, 1999, null, party2, false, false, 1);
		Candidate candidate2 = new Candidate("name2", "bk103460", 1122334460, 1997, null, party, false, false, 2);
		...
		repo.setStations(List.of(station, stationQuarantine, sercretService));
